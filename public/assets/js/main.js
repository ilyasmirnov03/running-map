...
const App = {
  ...
  UserMarker: class {
    ...
    addMarker(coords, runner) {
      this.markerObject = L.marker([coords.latitude, coords.longitude], { icon: this.marker })
        .addTo(App.map)
    ...
    async setPos(coords) {
      if (this.pos) {
        let distance = CalcDistance(this.pos.latitude, this.pos.longitude, coords.latitude, coords.longitude);
...
>>>>>>> 90114e2ce1a76cb5989da503192cb3e7c4c65f6c
