 ...
 */
class RunnerRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    public function save(Runner $entity, bool $flush = false): void
    {
    ...
    public function remove(Runner $entity, bool $flush = false): void
    {
